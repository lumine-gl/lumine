(function(){
  ...
  function Canvas(el, Scene, lumine, options){
    ...
    if(el){
      ...
      this.composer = new Composer(this.opts.renderer, this.opts);

      this.parent = this.opts.parent;

      this.setSize(this.opts.width, this.opts.height, this.opts.density, this.opts.offsetX, this.opts.offsetY);
  ...
  Canvas.prototype.setSize = function(width, height, density, offsetX, offsetY){
    ...
    if(this.el){
      ...
      this.renderer.setPixelRatio(this.density);
      this.renderer.setSize(this.size.width, this.size.height, this.opts.useStyle || false);

    }

    this.composer.setSize(this.size.width * this.density, this.size.height * this.density);
